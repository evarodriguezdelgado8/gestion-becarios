                    ...
                    <div className="flex w-full md:w-auto gap-3">
                        ...
                        {isAdmin && (
                            <button 
                                ...
                                className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm font-medium shadow-sm transition flex items-center gap-2 cursor-pointer"
                            >
                                    ...
                                    centers.data.map((centro) => (
                                        <tr key={centro.id} className="hover:bg-blue-50/10 transition-colors">
                                            <td className="px-4 py-4 align-middle">
                                                ...
                                                {centro.web && (
                                                    <a href={centro.web} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600 hover:underline flex items-center gap-1.5 text-sm font-medium mt-2 transition-colors cursor-pointer">
                                            ...
                                            <td className="px-4 py-4 align-middle">
                                                ...
                                                <div className="flex flex-col gap-2 text-sm text-gray-600 ml-6">
                                                    <div className="flex items-center gap-2">
                                                        <a href={`mailto:${centro.contact_email}`} className="hover:text-blue-600 hover:underline flex items-center gap-1.5 break-all cursor-pointer">
                                            ...
                                            <td className="px-4 py-4 align-middle">
                                                <div className="space-y-3">
                                                    <a 
                                                        ...
                                                        className="flex items-start gap-1.5 text-gray-800 font-medium hover:text-blue-600 group cursor-pointer"
                                                    >
                                                    ...
                                                    <div className="flex flex-col gap-2 pl-5 text-sm text-gray-600">
                                                        <div className="flex items-center gap-2">
                                                            <a href={`mailto:${centro.email}`} className="hover:text-blue-600 hover:underline flex items-center gap-1.5 break-all cursor-pointer">
                                            ...
                                            <td className="px-4 py-4 align-middle text-right">
                                                <div className="flex justify-end gap-1.5">
                                                    <button 
                                                        ...
                                                        className="p-2 bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-lg transition-all shadow-sm active:scale-95 border border-gray-200 cursor-pointer"
                                                        title="Ver Histórico"
                                                    >
                                                    ...
                                                    {isAdmin && (
                                                        <>
                                                            <button 
                                                                ...
                                                                className="p-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-all shadow-sm active:scale-95 cursor-pointer"
                                                                title="Editar"
                                                            >
                                                            ...
                                                            {(centro as any).active_interns_count > 0 ? (
                                                                ...
                                                                <button 
                                                                    ...
                                                                    className="p-2 bg-red-600 text-white hover:bg-red-700 rounded-lg transition-all shadow-sm active:scale-95 cursor-pointer"
                                                                    title="Borrar Centro"
                                                                >
                                                                    <Trash2 className="w-4 h-4" />
                                                                </button>
                ...
                <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                    ...
                    <div className="inline-flex shadow-sm rounded-lg overflow-hidden border border-gray-300">
                        <button 
                            ...
                            className={`px-4 py-2 bg-white transition border-r font-medium 
                                ${!centers.prev_page_url 
                        ...
                        <button 
                            ...
                            className={`px-4 py-2 bg-white transition font-medium 
                                ${!centers.next_page_url 
                                    ? 'opacity-50 cursor-not-allowed text-gray-400' 
                                    : 'hover:bg-gray-50 cursor-pointer text-gray-700'}`}
                        >
                            Siguiente
